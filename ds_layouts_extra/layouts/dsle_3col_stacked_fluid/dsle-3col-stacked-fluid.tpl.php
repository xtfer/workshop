...
/**
 * @file
 * Display Suite fluid 3 column 33/33/33 stacked template.
 */
...
?>
<<?php print $layout_wrapper; print $layout_attributes; ?> class="dsle-3col-stacked-fluid <?php print $classes;?> clearfix">
